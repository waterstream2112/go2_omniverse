...
def generate_launch_description():
    ...
    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join(
            get_package_share_directory("pointcloud_to_laserscan"), "params", "nav2_params.yaml"
        ),
    )
    ...
    return LaunchDescription(
        [
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={"map": "", "use_sim_time": use_sim_time, "params_file": "/home/nghiaho/Omniverse/go2_omniverse/go2_omniverse_ws/src/pointcloud_to_laserscan/params/nav2_params.yaml"}.items(),
            ),
